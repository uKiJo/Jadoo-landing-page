...
const Card: React.FC<CardProps> = (props) => {
  ...
  return (
    <div className="flex flex-col xl:h-[457px] xl:w-80 lg:h-[400px] lg:w-64 sm:w-52 sm:h-80 xs:w-64 xs:h-96 md:mb-4 xs:mb-8 lg:mr-12 md:mr-6 sm:mr-12 rounded-3xl card-shadow font-poppins text-paragraph">
