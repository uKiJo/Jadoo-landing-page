...
const Navbar = () => {
  ...
  return (
    <nav className="relative mt-12 mb-6 xs:mx-0 sm:mx-auto xs:w-full md:w-3/4 flex items-center xs:justify-between font-semibold text-primary xs:px-4 snap-start">
